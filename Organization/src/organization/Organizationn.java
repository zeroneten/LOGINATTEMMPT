 ...
 * @author ndirituedwin
 */
public class Organizationn extends javax.swing.JFrame {
Connection conn;
String sql;
String ff;
Statement stmt;
...
//               settersandgetters set1;
               String permision;
    /**
     * Creates new form Organizationn
     */
    public Organizationn() {
        initComponents();
    ...
    String pofile;
    String passsw;
    public Organizationn(String profilee,String una,String passwordd) {
        initComponents();
       conn=Dbconnection.Dbconnection();
        jTabbedPane1.setEnabledAt(0,false);jTabbedPane1.setEnabledAt(1, false);jTabbedPane1.setEnabledAt(2, false);
        jTabbedPane1.setEnabledAt(3, false);
    ...
    private void showmembership(){
          try{
         sql="  select (CONCAT(groups.Group_Name,', ',groups.Rec_Id))groupname,membership.Name,membership.Id_No,membership.Tel_No,membership.Date,membership.Rec_Id FROM groups,membership WHERE groups.Rec_Id=membership.Group_Id";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
...
//          System.out.print("Am here");
                      ...
                      String sql="update membership set Group_Id='"+number+"',Name='"+name+"',Id_No='"+idno+"',Tel_No='"+telno+"',Date='"+date+"' where Rec_Id='"+Integer.parseInt(va)+"'";
                           try{
                            ...
                            reset();    
                                ...
                                JOptionPane.showMessageDialog(null,"you must first fill the fields");
                            }
    ...
    private void delete(){
          if(jTabbedPane1.getSelectedIndex()==0){
             try{
            int ro=jtablegroups.getSelectedRow();
             va=jtablegroups.getModel().getValueAt(ro,0).toString();
            int confirmdelete=JOptionPane.showConfirmDialog(null,"Do you really want to delete " +va+" and all their records ?", "Delete", JOptionPane.YES_NO_OPTION);
                        if(confirmdelete==0){
    String sql="Delete from groups where Group_Name='"+va+"'";
...
//                            String sql="Delete from groups where Rec_Id='"+Integer.parseInt(va)+"'";
            ...
            JOptionPane.showMessageDialog(null,"you currently dont have any permissions to delete " +va+ " because it is being used in another table");
        }
        }
        else if(jTabbedPane1.getSelectedIndex()==1){
             try{
            int ro=jmembership.getSelectedRow();
             va=jmembership.getModel().getValueAt(ro, 1).toString();
            int confirmdelete=JOptionPane.showConfirmDialog(null,"Doyou really want to delete all from  " +va+" and all their records ?","Delete",JOptionPane.YES_NO_OPTION);
            if(confirmdelete==0){
                    String sql="Delete from membership where Name='"+va+"'";
...
//////             String delete="delete from membership where Rec_Id='"+Integer.parseInt(va)+"'";
          ...
          showmembership();
            ...
            JOptionPane.showMessageDialog(null," you currently dont have permission to delete " +va+ " because it is being used in another table");
        }
        }
        else if(jTabbedPane1.getSelectedIndex()==2){
          Scanner fromstr=new Scanner(cmbmember.getSelectedItem().toString());
     ...
     number=Integer.parseInt(fromstr.next());
               ...
               try{
          int ro=jcontributions.getSelectedRow();
        String va=jcontributions.getModel().getValueAt(ro,0).toString();
        int confirmdelete=JOptionPane.showConfirmDialog(null, "Do you really want to delete all from " +va+ " and all their records ?", "Delete",JOptionPane.YES_NO_OPTION);
    if(confirmdelete==0){
       String sql="Delete from contributions where Member_Id='"+number+"'";
...
//        String delete="delete from contributions where Rec_Id='"+Integer.parseInt(va)+"'";
            ...
            try{
            int ro=jTableuserregistration.getSelectedRow();
            String va=jTableuserregistration.getModel().getValueAt(ro,0).toString();
              int confirmdelete=JOptionPane.showConfirmDialog(null, "Do you really want to delete all from " +va+ " and all their records","Delete",JOptionPane.YES_NO_OPTION);
          if(confirmdelete==0){
          String sql="Delete from user_registration where Name='"+va+"'";
...
//        jDateChoosercontributions.setDate(null);
                ...
                JOptionPane.showMessageDialog(null,"fields must have data to empty");
            }
        }
        else if(jTabbedPane1.getSelectedIndex()==1){
              try{
 ...
 String sql="SELECT (CONCAT(membership.Name,', ',membership.Rec_Id))name,contributions.Type,contributions.Description,contributions.Amount,contributions.Date,contributions.Rec_Id FROM membership,contributions WHERE membership.Rec_Id=contributions.Member_Id AND contributions.Rec_Id='"+Integer.parseInt(va)+"' ";
   ...
   while(rs.next()){
    ...
    private void initComponents() {
        ...
        jtablegroups.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtablegroupsKeyReleased(evt);
            }
        });
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtgroupname, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
        ...
        jmembership.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jmembershipKeyReleased(evt);
            }
        });
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDateChoosermembership, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(27, 27, 27)
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbgroupid, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jcontributions.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jcontributionsKeyReleased(evt);
            }
        });
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDateChoosercontributions, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(14, 14, 14))
        );
        ...
        jTableuserregistration.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTableuserregistrationKeyReleased(evt);
            }
        });
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jDateChooseruserregistration, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/organization/edit-validated-icon.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/organization/Reset-icon.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/organization/Delete-2-icon.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/organization/Save-icon.png"))); // NOI18N
...
//        refresh();
    ...
    private void jtablegroupsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtablegroupsKeyReleased
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_jtablegroupsKeyReleased

    private void jmembershipKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jmembershipKeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_UP ||evt.getKeyCode()==KeyEvent.VK_DOWN){
              act="JHgf";
        int ro=jmembership.getSelectedRow();
 ...
 String sql="  select (CONCAT(groups.Group_Name,', ',groups.Rec_Id))ff,membership.Name,membership.Id_No,membership.Tel_No,membership.Date,membership.Rec_Id FROM groups,membership WHERE groups.Rec_Id=membership.Group_Id AND membership.Rec_Id='"+Integer.parseInt(va)+"'";   
  ...
  String   ff=rs.getString("ff");
    ...
    }//GEN-LAST:event_jmembershipKeyReleased

    private void jcontributionsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jcontributionsKeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_UP||evt.getKeyCode()==KeyEvent.VK_DOWN){
              act="JHgf";
        try{
 ...
 String sql="SELECT (CONCAT(membership.Name,', ',membership.Rec_Id))name,contributions.Type,contributions.Description,contributions.Amount,contributions.Date,contributions.Rec_Id FROM membership,contributions WHERE membership.Rec_Id=contributions.Member_Id AND contributions.Rec_Id='"+Integer.parseInt(va)+"' ";
   ...
   while(rs.next()){
    ...
    }//GEN-LAST:event_jcontributionsKeyReleased

    private void jTableuserregistrationKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableuserregistrationKeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_UP||evt.getKeyCode()==KeyEvent.VK_DOWN){
                 act="JHgf";
        try{
    ...
    }//GEN-LAST:event_jTableuserregistrationKeyReleased
...
//            jlabel1.setText(jText.getText());    
            
        }catch(NumberFormatException ex){
            JOptionPane.showMessageDialog(null,ex);
        }
//       idno=txtidno.getText();
//       int id1=Integer.parseInt(idno);
...
//               JOptionPane.showMessageDialog(null,"enter an integer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Organizationn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Organizationn().setVisible(true);
            }
        });
    }
